...
//     })
  ...
  return (
    <div className="row_WL">
      ...
      <div className="row__posters_WL">
        {movies.map((movie, key) => (
          <Link to={`/moviedetails/` + movie.id} className={`movie_links_WL ${isLargeRow && "movie_linksLarge_WL"}`}>
            <img
              key={key}
              className={`row__poster_WL ${isLargeRow && "row__posterLarge_WL"}`}
              src={`${base_url}${
